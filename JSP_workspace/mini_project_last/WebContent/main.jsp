		...
		<div id="select_t">
			<div>
				<form action="seat.jsp">
					...
					<input type="hidden" name="run_date" value="<%=today%>"> <input
						type="hidden" id="area1" name="city"> <input type="hidden"
						id="area2" name="branch"> <input type="hidden"
						id="selectmov" name="movie_name"> <input type="hidden"
