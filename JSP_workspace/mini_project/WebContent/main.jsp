	...
	<div class="date">
		...
		<div class="select_t">
			...
			<form action="seat.jsp">
				...
				<input type="hidden" id="time2" name="start_time"> 
				<input type="hidden" id="house" name="run_house">
				<c:forEach var="i" begin="9" end="22" step="2" varStatus="vs">
					<c:forEach var="j" begin="0" end="59" step="30">
					<button id="time" data-start_time="${i}:${j eq 0 ? '00': j}"data-run_house="${vs.count }">
						${i}:${j eq 0 ? '00': j}<br>
						${vs.count }관
					</button>
					</c:forEach>
